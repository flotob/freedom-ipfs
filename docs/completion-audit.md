...
| Directories and path resolution | UnixFS directory/path tests, HAMT listing tests, gateway directory index test, and escaped gateway directory listing test for directories without `index.html`. | Done |
