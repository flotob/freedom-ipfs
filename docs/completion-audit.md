...
Implementation audited code head: `037ecc5c8296b371af43f2dadd311f8378a4b040`; latest Apple-platform implementation/workflow CI evidence is recorded below by head SHA
...
```text
GitHub Actions iOS XCFramework run 25281324871 passed on 2026-05-03
Head SHA: 037ecc5c8296b371af43f2dadd311f8378a4b040
Job URL: https://github.com/flotob/freedom-ipfs/actions/runs/25281324871/job/74118944200
```
...
| Device/app verification runbook | `docs/ios-device-verification.md` defines app wiring, real-device matrix, Bee co-residency runs, live content cases, range checks, lifecycle checks, acceptance targets, and points to `docs/ios-device-evidence-template.csv` for structured measurement capture. | Done; evidence still missing |
