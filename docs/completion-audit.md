...
Implementation audited code head: `d4cf43feeb232a626386ae5df7cbedf2b87f699d`; latest Apple-platform implementation/workflow CI evidence is recorded below by head SHA
...
```text
GitHub Actions iOS XCFramework run 25283839486 passed on 2026-05-03
Head SHA: d4cf43feeb232a626386ae5df7cbedf2b87f699d
Job URL: https://github.com/flotob/freedom-ipfs/actions/runs/25283839486/job/74125095591
```
...
| Kubo parity | Deterministic Kubo-generated CIDv1/raw-leaf UnixFS, CIDv0/DAG-PB UnixFS, empty-file, encoded-path, HAMT, no-index directory listing, fixed/open-ended/suffix range, full/ranged `HEAD`, and directory-index parity tests. | Expanded |
