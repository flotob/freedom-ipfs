...
Implementation audited code head: `021917e0493048b37f853aa555fbb8566eb9988c`; latest Apple-platform implementation/workflow CI evidence is recorded below by head SHA
...
```text
GitHub Actions iOS XCFramework run 25282656719 passed on 2026-05-03
Head SHA: 021917e0493048b37f853aa555fbb8566eb9988c
Job URL: https://github.com/flotob/freedom-ipfs/actions/runs/25282656719/job/74122233831
```
...
| Directories and path resolution | UnixFS directory/path tests, HAMT listing tests, gateway directory index test, escaped gateway directory listing test for directories without `index.html`, and Kubo-generated no-index directory listing parity across raw-leaf, CIDv0 DAG-PB, and HAMT fixtures. | Done |
