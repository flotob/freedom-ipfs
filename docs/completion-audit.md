...
Implementation audited code head: `f632db33538af613c42129ffe62042836d1eee8b`; latest Apple-platform implementation/workflow CI evidence is recorded below by head SHA
...
```text
GitHub Actions iOS XCFramework run 25283055705 passed on 2026-05-03
Head SHA: f632db33538af613c42129ffe62042836d1eee8b
Job URL: https://github.com/flotob/freedom-ipfs/actions/runs/25283055705/job/74123212149
```
