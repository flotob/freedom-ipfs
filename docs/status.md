...
```text
GitHub Actions run: https://github.com/flotob/freedom-ipfs/actions/runs/25271226593
Head SHA: aa965b16c7ef3e33b102e6a7518d1cb0977ca83d
```

The macOS job ran on `macos-15` with Xcode 16.4. It built `FreedomIpfs.xcframework`, verified headers/module maps/exported C symbols, booted an iOS simulator, compiled and linked the Swift wrapper smoke, ran the gateway smoke through `simctl spawn booted`, built and installed a generated UIKit/WebKit app, rendered a CAR-backed gateway fixture in `WKWebView`, verified the DOM marker, and uploaded the XCFramework artifact `6768482321` (`60019725` bytes).
